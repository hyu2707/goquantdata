...
VALID_DATASOURCE = [DATASOURCE_POLYGON, DATASOURCE_BINANCE, DATASOURCE_CACHE, DATASOURCE_BITMEX]
VALID_FREQ = [FREQ_DAY, FREQ_MINUTE]

DATA_FILE_FMT = "{data_type}_{symbol}_{freq}_{start_date}_{end_date}"
